...
public class MenuProfesorController {
    ...
    private void volverAlMenuPrincipal() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/SistemaGestionEstudiantes/views/MenuPrincipal.fxml"));
            Parent root = loader.load();
            Stage mainStage = new Stage();
            mainStage.setTitle("Sistema de Gestión de Estudiantes");
